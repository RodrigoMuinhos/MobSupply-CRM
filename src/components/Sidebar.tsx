...
import {
  ...
  FaBook,
  FaBoxes,
  FaTruck, // NOVO ÍCONE ADICIONADO AQUI
} from 'react-icons/fa';
import {
  FaLinesLeaning,
  FaMoneyBills,
...
const Sidebar = () => {
  ...
  const sections = [
    {
      title: 'Dashboard',
      items: [{ label: 'Painel Geral', icon: <FaChartPie />, to: '/' }],
    },
    {
      title: 'Vendas',
      items: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Histórico Vendas', icon: <FaShoppingCart />, to: '/vendas/historico' },
      ],
    },
    {
      title: 'Financeiro',
    ...
    },
    {
      ...
      items: [
        { label: 'Atacado', icon: <FaBoxes />, to: '/atacado', isFirst: true },
        { label: 'Envios', icon: <FaTruck />, to: '/distribuicao' }, // NOVA ROTA
      ],
    },
  ];
